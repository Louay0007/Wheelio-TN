...
export default async function HelpPage({ searchParams }: PageProps) {
  ...
  const content = await listTypedContent("help", locale)
  ...
  return (
    <PageShell>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
        <HelpHubClient locale={locale} initialData={content} />
        <p className="mt-12 pt-6 text-sm text-black/55 dark:border-white/10 dark:text-white/55">
